        ...
        return (
            <div className='flex justify-center flex-wrap py-10'>
                ...
                <div className='max-w-2xl text-lg text-gray-700 dark:text-white my-auto p-10'>
                    <h2 className='text-4xl py-5 bold'>{original_title}</h2>
                    <p className='text-xl py-2'>{overview}</p>
                    ...
                    <p className='py-1'>Time: {runtime} minutes</p>
                    <p className='text-xl'>Status: {status}</p>
                    <p className='py-1'>Date: {release_date}</p>
                    
                    <p className='py-1'>Imdb : {imdb_id ? imdb_id : "not available"}</p>
                </div>
