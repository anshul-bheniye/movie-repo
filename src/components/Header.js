...
export const Header = () => {
  // state for search update hidden class
  ...
  const handleSubmit = (e) =>{
    e.preventDefault();
    const queryName = e.target.search.value; 
    e.target.reset();
    return navigate(`/search?q=${queryName}`)
  }

  return (
    <header >
      <nav className="border-b-2  bg-white border-gray-200 dark:bg-gray-900 dark:border-b">
        <div className="max-w-full flex flex-wrap items-center justify-between mx-auto p-4">
            <Link to="/" className="flex items-center">
                <img src={Logo} className="h-8 mr-3" alt="Movies Repo Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Movies Repo</span>
            </Link>
          <div className="flex md:order-2">
            ...
            >{darkMode ? <img src={Chewbacca} alt='light-mode'/> : <img src={Vader} alt='dark-mode'/> }</button>
            ...
            <input
                ...
                type="text"
                id="search-navbar"
                className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Search Movies..." />
            </form>
            ...
            {/* search menu */}
            <div
            className={`${update ? 'hidden' : ''} items-center justify-between w-full md:flex md:w-auto md:order-1`}
            id="navbar-search">
              <div className="relative mt-3 md:hidden">
                ...
                type="text"
                id="search-navbar"
                className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Movies..." />
                </form>
              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                  <NavLink to="/upcoming" className={({isActive})=> isActive ? activeClass : inActiveClass}>Upcomming</NavLink>
                </li>
                <li>
